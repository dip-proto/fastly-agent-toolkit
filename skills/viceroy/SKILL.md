---
name: viceroy
description: "Run Fastly Compute WASM applications locally with Viceroy. Use when you need to start a local Compute development server, configure fastly.toml for local backends/stores, run Rust unit tests with cargo-nextest, or adapt core WASM modules to the Component Model."
---
